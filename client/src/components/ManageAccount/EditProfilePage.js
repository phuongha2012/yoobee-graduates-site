    ...
    return (
        <>
            ...
            <div className="col-lg-8 col-md-10 col-sm-10 mx-auto">
                ...
                <div className="accountPage__banner"></div>
                <div
                ...
                <form className="mt-5" onSubmit={handleSubmit}>
                    ...
                    <label className="my-1 mr-2">Course</label>
                    <select
                    ...
                    >
                        ...
                        <option value="Level 6 Creative Digital Design">
                            Level 6 Creative Digital Design
                        </option>
                        <option value="Level 6 Web Development and UX Design">
                            Level 6 Web Development and UX Design
                        </option>
                        <option value="Level 6 Diploma in Screen Production">
                            Level 6 Diploma in Screen Production
                        </option>
                        <option value="Level 6 Diploma in 3D Production">
                            Level 6 Diploma in 3D Production
                        </option>
                        <option value="Level 7 Diploma in Advanced 3D Production">
                    ...
                    <h4 className="mt-2 mb-3">Highlighted skills</h4>
                        ...
                        <div className="col-sm-6 col-md-3">
                            <div className="form-check">
                                <input
                                    ...
                                    onChange={onCheckboxChecked}
                                />
                                <label className="form-check-label">CG</label>
                            </div>
                        </div>
                    </div>
                    <div className="form-row justify-content-between">
